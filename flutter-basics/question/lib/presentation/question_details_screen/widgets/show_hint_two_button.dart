...
class ShowHintTwoButton extends StatelessWidget {
  const ShowHintTwoButton({super.key, required this.question});
            ...
            child: InkWell(
              onTap: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                    HelpSnackbar(helpText: question.hintTwo, isHint: true));
              },
